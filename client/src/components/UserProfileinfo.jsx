...
const UserProfileinfo = ({user,posts,profileId,setshowEdit}) => {
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        <div className='flex flex-col md:flex-row itesm-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'> 
                <div className='flex flex-col md:flex-row itesm-start justify-between'>
                    <div>
                    ...
                    {!profileId && <button onClick={() => setshowEdit(true)} className='flex items-center gap-2 border border-gray-300 hover-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer'>
