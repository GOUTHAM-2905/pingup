    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
          <div className='mb-8'>
            ...
            <p className='text-slate-600'>Connectoin with amazing people and grow your network  </p>
          </div>
          {/* search */}
          <div className='mb-8 shadow-md rounded-md border border-slate-200/60 bg-white/80'>
            <div className='p-6'>
              <div className='relative'>
                  <Search className='absolute left-3 top-1/2 transform -trnslate-y01/2 text-slate-400 w-5 h-5'/> 
